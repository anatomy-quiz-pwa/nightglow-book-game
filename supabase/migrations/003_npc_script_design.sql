...
-- unlock_answer 改為 A/B/C/D（選擇題正確選項）
...
'穿越時空的旅人，見證人類從森林古猿演化為草原居民的過程。',
'從樹棲移動到雙足行走，發生了什麼？',
'骨盆與股骨形狀的改變，適應長距離移動。',
'人類演化出雙足行走的主要原因？',
'增加跳躍能力', '增加跑步速度', '長距離移動更省能', '手臂變短',
'人類演化出雙足行走的主要原因？', 'C'),

-- 6. 典藏守書人
('a1b2c3d4-0006-4000-8000-000000000006', '典藏守書人', '夜光書店', '/characters/Archive Keeper.webp', '跨領域整合', '每本書都只說了一部分。',
'拆書樂園的典藏者，讀過所有書，理解書與書之間的關係。',
'彈性能量、演化、筋膜、生物力學、神經控制，各自解釋了行走的一部分。',
'沒有一本書能單獨解釋完整的「行走」。',
'對「行走」最合理的跨領域理解是？',
'單一肌肉作用', '單一關節運動', '單一神經控制', '多系統整合現象',
'對「行走」最合理的跨領域理解是？', 'D')
